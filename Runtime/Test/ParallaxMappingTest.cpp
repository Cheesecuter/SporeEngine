...
//    // -------------------------
//    Shader shader("./Assets/Shaders/ParallaxMappingVertex.glsl", "./Assets/Shaders/ParallaxMappingFragment.glsl");
//
//    // load textures
//    // -------------
//    unsigned int diffuseMap = loadTexture("./Assets/Textures/stone.png");
//    unsigned int normalMap = loadTexture("./Assets/Textures/stone_normal.png");
//    unsigned int heightMap = loadTexture("./Assets/Textures/stone_disp.png");
//
