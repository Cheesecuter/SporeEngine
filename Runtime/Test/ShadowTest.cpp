...
//    // -------------------------
//    Shader shader("./Assets/Shaders/ShadowMappingVertex.glsl", "./Assets/Shaders/ShadowMappingFragment.glsl");
//    Shader simpleDepthShader("./Assets/Shaders/ShadowMappingDepthVertex.glsl", "./Assets/Shaders/ShadowMappingDepthFragment.glsl");
//    Shader debugDepthQuad("./Assets/Shaders/DebugQuadVertex.glsl", "./Assets/Shaders/DebugQuadFragment.glsl");
//
