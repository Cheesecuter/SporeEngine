...
//    // -------------------------
//    Shader shader("./Assets/Shaders/LightingVertex.glsl", "./Assets/Shaders/LightingFragment.glsl");
//    Shader hdrShader("./Assets/Shaders/HDRVertex.glsl", "./Assets/Shaders/HDRFragment.glsl");
//
//    // load textures
//    // -------------
//    unsigned int woodTexture = loadTexture("./Assets/Textures/stone.png", true); // note that we're loading the texture as an SRGB texture
//
