...
//
////template<class T>
////MonoObject* CreateMonoObject(T* cppObject)
////{
////    MonoClass* monoClass = mono_get_object_class((MonoObject*) 0);
////    MonoObject* monoObject = mono_object_new(mono_domain_get(), monoClass);
////
////    MonoClass* dataOnHeadClass = mono_class_from_name(mono_get_corlib(), "Spore", "TransformComponent");
////    //MonoClassField* cppObjectPtrField = mono_class_get_field_from_name(dataOnHeadClass, "_cppObjectPtr");
////
////    DataOnHead* dataOnHead = (DataOnHead*) mono_object_unbox(monoObject);
////    dataOnHead->_cppObjectPtr = cppObject;
////
////    return monoObject;
////}
//
...
//}
//
//static void TransformCBind(MonoObject* self)
//{
//    Class_bind<TransformC>(self);
//}
//
//static void TransformCSetPosition(MonoObject* self, MonoObject* pos)
//{
//    TransformC* t = convert<TransformC>(self);
//    vec3f* v = convert<vec3f>(pos);
//    //t->SetPosition(vec3f(x, y, z));
//    vec3f pos1 = *v;
//    t->SetPosition(pos1);
//}
//
//static MonoObject* TransformCGetPosition(MonoObject* self)
//{
//    TransformC* t = convert<TransformC>(self);
...
//}
//
//static Direction ClassA_getDirection(MonoObject* self)
//{
//    ClassA* t = convert<ClassA>(self);
//
...
//    std::string MonoPath = "./SDKs/Mono";
//    std::string ManagedLibraryPath = "D:/SporeEngine/ScriptEngine/ScriptEngine/bin/Debug/net6.0/ScriptEngine.dll";
//
...
//    mono_add_internal_call("TestAllRuntime.ClassA::ClassA_getDirection", reinterpret_cast<void*>(&ClassA_getDirection));
...
//    );*/
//
//    mono_add_internal_call("Spore.TransformComponent::TransformComponentBind", reinterpret_cast<void*>(&TransformCBind));
//    mono_add_internal_call("Spore.TransformComponent::SetPosition", reinterpret_cast<void*>(&TransformCSetPosition));
//    mono_add_internal_call("Spore.TransformComponent::GetPosition", reinterpret_cast<void*>(&TransformCGetPosition));
//
...
//    //===============================================================================
//    
//    /*MonoClass* main_class = mono_class_from_name(image, "TestAllRuntime", "MainClass");
//
//    const bool include_namespace = true;
//    MonoMethodDesc* managed_method_desc = mono_method_desc_new("TestAllRuntime.MainClass:Main()", include_namespace);
...
//
//    MonoClass* main_class = mono_class_from_name(image, "Spore", "MainClass");
//
//    const bool include_namespace = true;
//    MonoMethodDesc* managed_method_desc = mono_method_desc_new("Spore.MainClass:Main()", include_namespace);
//    MonoMethod* managed_method = mono_method_desc_search_in_class(managed_method_desc, main_class);
//    mono_method_desc_free(managed_method_desc);
//
//    MonoMethod* mainMethod = mono_class_get_method_from_name(main_class, "Main", 1);
